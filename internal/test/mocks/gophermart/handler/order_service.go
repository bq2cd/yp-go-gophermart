...
//
//	mockgen -typed -destination=../../test/mocks/gophermart/handler/order_service.go -package=mocks github.com/bq2cd/yp-go-gophermart/internal/gophermart/handler OrderService
//
